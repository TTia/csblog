...
Funzionalità: Gestione dei post
  ...
  Scenario: Scrittura di un nuovo post
    Dato il post "Lorem Ipsum" non è leggibile su CSBlog
  ...
  Scenario: Cancellazione di un post
    ...
    E il post "Lorem Ipsum" non è leggibile su CSBlog
  ...
  Scenario: Modifica di un post
    ...
    E salvo il post
    Allora il post "Lorem Ipsum2" non è leggibile su CSBlog
    E il post "Lorem Ipsum" è leggibile su CSBlog
  ...
  Scenario: Tentativo di creazione di un post con titolo invalido
    ...
    E il post "LI" non è leggibile su CSBlog
