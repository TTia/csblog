...
Funzionalità: Introducendo il (S)CSS
  ...
  Scenario: intestazione e pié di pagina
    ...
    Allora l_intestazione è posizionata all_inizio
    E il piè di pagina è posizionato alla fine

  Scenario: l'intestazione ed il piè di pagina hanno lo stesso schema di colori
    Dato è presente l'intestazione
  ...
  Scenario: i collegamenti raffigurati tramite immagini devono anche avere una descrizione testuale
